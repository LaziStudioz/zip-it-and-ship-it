...
import { getFileExtensionForFormat, ModuleFileExtensions, ModuleFormat } from './module_format.js'
...
const POSSIBLE_LAMBDA_ENTRY_EXTENSIONS = [ModuleFileExtensions.JS, ModuleFileExtensions.MJS, ModuleFileExtensions.CJS]
...
const getEntryFileName = ({ extension, filename }: { extension: ModuleFileExtensions; filename: string }) =>
